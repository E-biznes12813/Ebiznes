...
*/
  ...
  def addProduct = Action.async{ implicit request =>
    ...
    productForm.bindFromRequest.fold(
      ...
      product => {
        productsRepo.create(product.name, product.description,product.kayword, product.category).map { _ =>
 ...
 */
case class CreateProductForm(name: String, description: String,kayword: String, category: Int)
